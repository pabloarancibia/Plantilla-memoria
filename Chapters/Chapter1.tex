...
No es necesario conocer el trabajo específico que se está efectuando en cada momento, sino que basta con saber la etapa actual del proceso.
...
\begin{itemize}
	...
	\item Desarrollo e implementación de la infraestructura total del sistema, servidor basado en contenedores para servicio web, API Rest, broker mqtt y base de datos. 
